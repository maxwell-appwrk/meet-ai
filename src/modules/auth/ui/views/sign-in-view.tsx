...
import { Video, OctagonAlert, Mail, Lock, Github } from "lucide-react";
import { z } from "zod";
                            ...
                            <div className="flex flex-col items-center justify-center text-white space-y-6">
                                ...
                                <div className="mt-8 text-center max-w-sm">
                                    <p className="text-emerald-50/90 text-sm leading-relaxed">
                                        Transform your meetings with AI-powered insights, automated transcriptions, and intelligent summaries.
                                    </p>
                                </div>
                            </div>
